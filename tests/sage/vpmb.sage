...
class State(object):
    ...
    def validate_data(self):
        ...
        if (self.altitude_values['Diver_Acclimatized_at_Altitude'] == 'YES') or (self.altitude_values['Diver_Acclimatized_at_Altitude'] == 'yes'):
            self.Diver_Acclimatized = True
        elif (self.altitude_values['Diver_Acclimatized_at_Altitude'] == 'NO') or (self.altitude_values['Diver_Acclimatized_at_Altitude'] == 'no'):
