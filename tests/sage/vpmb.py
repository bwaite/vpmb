# This file was *autogenerated* from the file vpmb.sage.
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_240p03 = RealNumber('240.03'); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_33p0 = RealNumber('33.0'); _sage_const_70p69 = RealNumber('70.69'); _sage_const_147p42 = RealNumber('147.42'); _sage_const_390p0 = RealNumber('390.0'); _sage_const_288p15 = RealNumber('288.15'); _sage_const_54p3 = RealNumber('54.3'); _sage_const_109p0 = RealNumber('109.0'); _sage_const_20p53 = RealNumber('20.53'); _sage_const_4p72 = RealNumber('4.72'); _sage_const_187p0 = RealNumber('187.0'); _sage_const_8p0 = RealNumber('8.0'); _sage_const_8p31432 = RealNumber('8.31432'); _sage_const_1p0En3 = RealNumber('1.0E-3'); _sage_const_1p0En6 = RealNumber('1.0E-6'); _sage_const_1000p0 = RealNumber('1000.0'); _sage_const_101325p0 = RealNumber('101325.0'); _sage_const_498p0 = RealNumber('498.0'); _sage_const_635p0 = RealNumber('635.0'); _sage_const_14p48 = RealNumber('14.48'); _sage_const_0p0 = RealNumber('0.0'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_18p5 = RealNumber('18.5'); _sage_const_10p1325 = RealNumber('10.1325'); _sage_const_41p20 = RealNumber('41.20'); _sage_const_90p34 = RealNumber('90.34'); _sage_const_9144p0 = RealNumber('9144.0'); _sage_const_188p24 = RealNumber('188.24'); _sage_const_0p2 = RealNumber('0.2'); _sage_const_146p0 = RealNumber('146.0'); _sage_const_30000p0 = RealNumber('30000.0'); _sage_const_60p0 = RealNumber('60.0'); _sage_const_0p5 = RealNumber('0.5'); _sage_const_3p0 = RealNumber('3.0'); _sage_const_77p0 = RealNumber('77.0'); _sage_const_4p0 = RealNumber('4.0'); _sage_const_1p0En12 = RealNumber('1.0E-12'); _sage_const_305p0 = RealNumber('305.0'); _sage_const_0p79 = RealNumber('0.79'); _sage_const_2p0 = RealNumber('2.0'); _sage_const_1p35 = RealNumber('1.35'); _sage_const_115p29 = RealNumber('115.29'); _sage_const_5p0 = RealNumber('5.0'); _sage_const_99 = Integer(99); _sage_const_6369p0 = RealNumber('6369.0'); _sage_const_16 = Integer(16); _sage_const_55p19 = RealNumber('55.19'); _sage_const_760p0 = RealNumber('760.0'); _sage_const_1p607 = RealNumber('1.607'); _sage_const_2 = Integer(2); _sage_const_12p5 = RealNumber('12.5'); _sage_const_38p3 = RealNumber('38.3'); _sage_const_1p88 = RealNumber('1.88'); _sage_const_6p5 = RealNumber('6.5'); _sage_const_100 = Integer(100); _sage_const_6p99 = RealNumber('6.99'); _sage_const_0p493 = RealNumber('0.493'); _sage_const_29p11 = RealNumber('29.11'); _sage_const_239p0 = RealNumber('239.0'); _sage_const_3280p839895 = RealNumber('3280.839895'); _sage_const_9p80665 = RealNumber('9.80665'); _sage_const_28p9644 = RealNumber('28.9644'); _sage_const_10p21 = RealNumber('10.21'); _sage_const_27p0 = RealNumber('27.0'); _sage_const_3p02 = RealNumber('3.02'); _sage_const_10p0 = RealNumber('10.0')#!/usr/bin/python
...
class State(object):
    ...
    def __init__(self, input_file_name=None, json_input=None):
        ...
        # integers
        self.Number_of_Mixes = _sage_const_0
        self.Number_of_Changes = _sage_const_0
        self.Segment_Number_Start_of_Ascent = _sage_const_0
        self.Repetitive_Dive_Flag = _sage_const_0
        ...
        #floats
        self.Ascent_Ceiling_Depth = _sage_const_0p0
        self.Deco_Stop_Depth = _sage_const_0p0
        self.Step_Size = _sage_const_0p0
        self.Sum_Check = _sage_const_0p0
        self.Depth = _sage_const_0p0
        self.Ending_Depth = _sage_const_0p0
        self.Starting_Depth = _sage_const_0p0
        self.Rate = _sage_const_0p0
        self.Run_Time_End_of_Segment = _sage_const_0p0
        self.Last_Run_Time = _sage_const_0p0
        self.Stop_Time = _sage_const_0p0
        self.Depth_Start_of_Deco_Zone = _sage_const_0p0
        self.Deepest_Possible_Stop_Depth = _sage_const_0p0
        self.First_Stop_Depth = _sage_const_0p0
        self.Critical_Volume_Comparison = _sage_const_0p0
        self.Next_Stop = _sage_const_0p0
        self.Run_Time_Start_of_Deco_Zone = _sage_const_0p0
        self.Critical_Radius_N2_Microns = _sage_const_0p0
        self.Critical_Radius_He_Microns = _sage_const_0p0
        self.Run_Time_Start_of_Ascent = _sage_const_0p0
        self.Altitude_of_Dive = _sage_const_0p0
        self.Deco_Phase_Volume_Time = _sage_const_0p0
        self.Surface_Interval_Time = _sage_const_0p0
        self.Pressure_Other_Gases_mmHg = _sage_const_0p0
        self.Regenerated_Radius_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Regenerated_Radius_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]
        ...
        self.He_Pressure_Start_of_Ascent = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.N2_Pressure_Start_of_Ascent = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.He_Pressure_Start_of_Deco_Zone = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.N2_Pressure_Start_of_Deco_Zone = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Phase_Volume_Time = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Last_Phase_Volume_Time = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Allowable_Gradient_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Allowable_Gradient_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Adjusted_Crushing_Pressure_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Adjusted_Crushing_Pressure_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Initial_Allowable_Gradient_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Initial_Allowable_Gradient_He = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Deco_Gradient_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Deco_Gradient_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]

        # GLOBAL CONSTANTS

        self.Water_Vapor_Pressure = _sage_const_0p0
        self.Surface_Tension_Gamma = _sage_const_0p0
        self.Skin_Compression_GammaC = _sage_const_0p0
        self.Crit_Volume_Parameter_Lambda = _sage_const_0p0
        self.Minimum_Deco_Stop_Time = _sage_const_0p0
        self.Regeneration_Time_Constant = _sage_const_0p0
        self.Constant_Pressure_Other_Gases = _sage_const_0p0
        self.Gradient_Onset_of_Imperm_Atm = _sage_const_0p0

        self.ATM = _sage_const_101325p0  # 1 atm of pressure
        self.fraction_inert_gas = _sage_const_0p79  # oxygen = 21% of air so this is what's left over

        # GLOBAL VARIABLES

        self.Segment_Number = _sage_const_0
        self.Run_Time = _sage_const_0p0
        self.Segment_Time = _sage_const_0p0
        self.Ending_Ambient_Pressure = _sage_const_0p0
        self.Mix_Number = _sage_const_0
        self.Barometric_Pressure = _sage_const_0p0

        self.units_fsw = False
        self.Units_Factor = _sage_const_0p0

        # GLOBAL ARRAYS

        ## Float
        self.Helium_Time_Constant = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Nitrogen_Time_Constant = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Helium_Pressure = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Nitrogen_Pressure = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Initial_Helium_Pressure =  [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Initial_Nitrogen_Pressure =  [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Fraction_Oxygen = []
        self.Fraction_Helium = []
        self.Fraction_Nitrogen = []

        self.Initial_Critical_Radius_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Initial_Critical_Radius_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Adjusted_Critical_Radius_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Adjusted_Critical_Radius_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Max_Crushing_Pressure_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Max_Crushing_Pressure_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Surface_Phase_Volume_Time = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Max_Actual_Gradient = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Amb_Pressure_Onset_of_Imperm = [_sage_const_0p0  for i in range(_sage_const_16 )]
        self.Gas_Tension_Onset_of_Imperm = [_sage_const_0p0  for i in range(_sage_const_16 )]

        self.Diver_Acclimatized = None

        # ASSIGN HALF-TIME VALUES TO BUHLMANN COMPARTMENT ARRAYS
        self.Helium_Half_Time = [_sage_const_1p88 , _sage_const_3p02 , _sage_const_4p72 , _sage_const_6p99 , _sage_const_10p21 , _sage_const_14p48 , _sage_const_20p53 , _sage_const_29p11 , _sage_const_41p20 ,
                          _sage_const_55p19 , _sage_const_70p69 , _sage_const_90p34 , _sage_const_115p29 , _sage_const_147p42 , _sage_const_188p24 , _sage_const_240p03 ]

        self.Nitrogen_Half_Time = [_sage_const_5p0 , _sage_const_8p0 , _sage_const_12p5 , _sage_const_18p5 , _sage_const_27p0 , _sage_const_38p3 , _sage_const_54p3 , _sage_const_77p0 , _sage_const_109p0 ,
                            _sage_const_146p0 , _sage_const_187p0 , _sage_const_239p0 , _sage_const_305p0 , _sage_const_390p0 , _sage_const_498p0 , _sage_const_635p0 ]
    ...
    def GAS_LOADINGS_SURFACE_INTERVAL(self, Surface_Interval_Time):
        ...
        Inspired_Helium_Pressure = _sage_const_0p0
    ...
    def _new_critical_radius(self, Max_Actual_Gradient_Pascals, Adj_Crush_Pressure_Pascals):
        ...
        """
        return  ((_sage_const_2p0  * self.Surface_Tension_Gamma * (self.Skin_Compression_GammaC - self.Surface_Tension_Gamma))) / (Max_Actual_Gradient_Pascals * self.Skin_Compression_GammaC - self.Surface_Tension_Gamma * Adj_Crush_Pressure_Pascals)
    ...
    def CALC_MAX_ACTUAL_GRADIENT(self, Deco_Stop_Depth):
        ...
        for i in range(_sage_const_16 ):
            ...
            if Compartment_Gradient <= _sage_const_0p0 :
                Compartment_Gradient = _sage_const_0p0
    ...
    def VPM_ALTITUDE_DIVE_ALGORITHM(self, altitude_settings):
        ...
        Ascent_to_Altitude_Time = altitude_settings['Ascent_to_Altitude_Hours'] * _sage_const_60p0
        Time_at_Altitude_Before_Dive = altitude_settings['Hours_at_Altitude_Before_Dive'] * _sage_const_60p0
        ...
        if self.Diver_Acclimatized:
            ...
            for i in range(_sage_const_16 ):
                self.Adjusted_Critical_Radius_N2[i] = self.Initial_Critical_Radius_N2[i]
                self.Adjusted_Critical_Radius_He[i] = self.Initial_Critical_Radius_He[i]
                self.Helium_Pressure[i] = _sage_const_0p0
                self.Nitrogen_Pressure[i] = (self.Barometric_Pressure - self.Water_Vapor_Pressure) * self.fraction_inert_gas
        else:
            if (altitude_settings['Starting_Acclimatized_Altitude'] >= altitude_settings['Altitude_of_Dive']) or (altitude_settings['Starting_Acclimatized_Altitude'] < _sage_const_0p0 ):
            ...
            for i in range(_sage_const_16 ):
                ...
                Gradient_He_Bubble_Formation = ((_sage_const_2p0  * self.Surface_Tension_Gamma * (self.Skin_Compression_GammaC - self.Surface_Tension_Gamma)) / (self.Initial_Critical_Radius_He[i] * self.Skin_Compression_GammaC))

                if Compartment_Gradient_Pascals > Gradient_He_Bubble_Formation:

                    New_Critical_Radius_He = ((_sage_const_2p0  * self.Surface_Tension_Gamma * (self.Skin_Compression_GammaC - self.Surface_Tension_Gamma))) / (Compartment_Gradient_Pascals * self.Skin_Compression_GammaC)
                    ...
                    Ending_Radius_He = _sage_const_1p0 /(Compartment_Gradient_Pascals/ (_sage_const_2p0  * (self.Surface_Tension_Gamma - self.Skin_Compression_GammaC))  + _sage_const_1p0 / self.Initial_Critical_Radius_He[i])
                ...
                Gradient_N2_Bubble_Formation = ((_sage_const_2p0  * self.Surface_Tension_Gamma * (self.Skin_Compression_GammaC - self.Surface_Tension_Gamma)) / (self.Initial_Critical_Radius_N2[i] * self.Skin_Compression_GammaC))

                if Compartment_Gradient_Pascals > Gradient_N2_Bubble_Formation:

                    New_Critical_Radius_N2 = ((_sage_const_2p0  * self.Surface_Tension_Gamma * (self.Skin_Compression_GammaC - self.Surface_Tension_Gamma))) / (Compartment_Gradient_Pascals * self.Skin_Compression_GammaC)
                    ...
                    Ending_Radius_N2 = _sage_const_1p0 /(Compartment_Gradient_Pascals/ (_sage_const_2p0 *(self.Surface_Tension_Gamma - self.Skin_Compression_GammaC))  + _sage_const_1p0 /self.Initial_Critical_Radius_N2[i])
    ...
    def GAS_LOADINGS_ASCENT_DESCENT(self, Starting_Depth, Ending_Depth, Rate):
        ...
        self.Segment_Number = self.Segment_Number + _sage_const_1
        ...
        Initial_Inspired_He_Pressure = (Starting_Ambient_Pressure - self.Water_Vapor_Pressure) * self.Fraction_Helium[self.Mix_Number - _sage_const_1 ]
        Initial_Inspired_N2_Pressure = (Starting_Ambient_Pressure - self.Water_Vapor_Pressure) * self.Fraction_Nitrogen[self.Mix_Number - _sage_const_1 ]
        Helium_Rate = Rate * self.Fraction_Helium[self.Mix_Number - _sage_const_1 ]
        Nitrogen_Rate = Rate * self.Fraction_Nitrogen[self.Mix_Number - _sage_const_1 ]
    ...
    def _crushing_pressure_helper(self, Radius_Onset_of_Imperm_Molecule, Ending_Ambient_Pressure_Pa, Amb_Press_Onset_of_Imperm_Pa, Gas_Tension_Onset_of_Imperm_Pa, Gradient_Onset_of_Imperm_Pa):
        ...
        A = Ending_Ambient_Pressure_Pa - Amb_Press_Onset_of_Imperm_Pa + Gas_Tension_Onset_of_Imperm_Pa + (_sage_const_2p0  * (self.Skin_Compression_GammaC - self.Surface_Tension_Gamma)) / Radius_Onset_of_Imperm_Molecule
        B = _sage_const_2p0  * (self.Skin_Compression_GammaC - self.Surface_Tension_Gamma)
        C = Gas_Tension_Onset_of_Imperm_Pa * Radius_Onset_of_Imperm_Molecule**_sage_const_3

        High_Bound = Radius_Onset_of_Imperm_Molecule
        Low_Bound = B / A

        Ending_Radius = RADIUS_ROOT_FINDER(A, B, C, Low_Bound, High_Bound)
        Crushing_Pressure_Pascals = Gradient_Onset_of_Imperm_Pa + Ending_Ambient_Pressure_Pa - Amb_Press_Onset_of_Imperm_Pa +  Gas_Tension_Onset_of_Imperm_Pa * (_sage_const_1p0  - Radius_Onset_of_Imperm_Molecule**_sage_const_3  / Ending_Radius**_sage_const_3 )
    ...
    def CALC_CRUSHING_PRESSURE(self, Starting_Depth, Ending_Depth, Rate):
        ...
        Ending_Radius_He = _sage_const_0p0
        Ending_Radius_N2 = _sage_const_0p0
        ...
        for i in range(_sage_const_16 ):
            ...
            Radius_Onset_of_Imperm_He = _sage_const_1p0  / (Gradient_Onset_of_Imperm_Pa / (_sage_const_2p0  * (self.settings_values['Skin_Compression_GammaC'] - self.settings_values['Surface_Tension_Gamma'])) + _sage_const_1p0  / self.Adjusted_Critical_Radius_He[i])

            Radius_Onset_of_Imperm_N2 = _sage_const_1p0 /(Gradient_Onset_of_Imperm_Pa/ (_sage_const_2p0  * (self.settings_values['Skin_Compression_GammaC'] - self.settings_values['Surface_Tension_Gamma'])) + _sage_const_1p0  / self.Adjusted_Critical_Radius_N2[i])
    ...
    def ONSET_OF_IMPERMEABILITY(self, Starting_Ambient_Pressure, Ending_Ambient_Pressure, Rate, i):
        ...
        if(Function_at_High_Bound * Function_at_Low_Bound) >= _sage_const_0p0 :
        ...
        if Function_at_Low_Bound < _sage_const_0p0 :
            Time = Low_Bound
        ...
        for j in range(_sage_const_100 ):
            ...
            Differential_Change = Last_Diff_Change * _sage_const_0p5
            ...
            if Function_at_Mid_Range <= _sage_const_0p0 :
                Time = Mid_Range_Time

            # When a solution with the desired accuracy is found, the program breaks
            if (abs(Differential_Change) < _sage_const_1p0En3 ) or (Function_at_Mid_Range == _sage_const_0p0 ):
                break
    ...
    def GAS_LOADINGS_CONSTANT_DEPTH(self, Depth, Run_Time_End_of_Segment):
        ...
        Inspired_Helium_Pressure = (Ambient_Pressure - self.Water_Vapor_Pressure) * self.Fraction_Helium[self.Mix_Number - _sage_const_1 ]

        Inspired_Nitrogen_Pressure = (Ambient_Pressure - self.Water_Vapor_Pressure) * self.Fraction_Nitrogen[self.Mix_Number - _sage_const_1 ]

        self.Ending_Ambient_Pressure = Ambient_Pressure

        Temp_Helium_Pressure = _sage_const_0p0
        Temp_Nitrogen_Pressure = _sage_const_0p0
    ...
    def NUCLEAR_REGENERATION(self, Dive_Time):
        ...
        for i in range(_sage_const_16 ):
            ...
            Ending_Radius_He = _sage_const_1p0 /(Crushing_Pressure_Pascals_He / (_sage_const_2p0  * (self.settings_values['Skin_Compression_GammaC'] - self.settings_values['Surface_Tension_Gamma'])) + _sage_const_1p0 /self.Adjusted_Critical_Radius_He[i])

            Ending_Radius_N2 = _sage_const_1p0 /(Crushing_Pressure_Pascals_N2/ (_sage_const_2p0  * (self.settings_values['Skin_Compression_GammaC'] - self.settings_values['Surface_Tension_Gamma'])) + _sage_const_1p0 / self.Adjusted_Critical_Radius_N2[i])
    ...
    def CALC_INITIAL_ALLOWABLE_GRADIENT(self):
        ...
        for i in range(_sage_const_16 ):
            Initial_Allowable_Grad_N2_Pa = ((_sage_const_2p0  * self.settings_values['Surface_Tension_Gamma'] * (self.settings_values['Skin_Compression_GammaC'] - self.settings_values['Surface_Tension_Gamma'])) / (self.Regenerated_Radius_N2[i] * self.settings_values['Skin_Compression_GammaC']))

            Initial_Allowable_Grad_He_Pa = ((_sage_const_2p0  * self.settings_values['Surface_Tension_Gamma'] * (self.settings_values['Skin_Compression_GammaC'] - self.settings_values['Surface_Tension_Gamma'])) / (self.Regenerated_Radius_He[i] * self.settings_values['Skin_Compression_GammaC']))
    ...
    def CALC_START_OF_DECO_ZONE(self, Starting_Depth, Rate):
        ...
        Low_Bound = _sage_const_0p0
        High_Bound = -_sage_const_1p0  * (Starting_Ambient_Pressure / Rate)
    ...
    def CALC_ASCENT_CEILING(self):
        ...
        Gas_Loading = _sage_const_0p0
        Weighted_Allowable_Gradient = _sage_const_0p0
        Tolerated_Ambient_Pressure = _sage_const_0p0
        Compartment_Ascent_Ceiling = [_sage_const_0p0  for i in range(_sage_const_16 )]
        ...
        for i in range(_sage_const_16 ):
            ...
            if Gas_Loading > _sage_const_0p0 :
            ...
            if Tolerated_Ambient_Pressure < _sage_const_0p0 :
                Tolerated_Ambient_Pressure = _sage_const_0p0
        ...
        self.Ascent_Ceiling_Depth = Compartment_Ascent_Ceiling[_sage_const_0 ]
    ...
    def PROJECTED_ASCENT(self, Starting_Depth, Rate, Step_Size):
        ...
        Temp_Gas_Loading = [_sage_const_0p0  for i in range(_sage_const_16 )]
        Allowable_Gas_Loading = [_sage_const_0p0  for i in range(_sage_const_16 )]
        Initial_Helium_Pressure = [_sage_const_0p0  for i in range(_sage_const_16 )]
        Initial_Nitrogen_Pressure = [_sage_const_0p0  for i in range(_sage_const_16 )]
        ...
        while(True):
            ...
            for i in range(_sage_const_16 ):
                ...
                if Temp_Gas_Loading[i] > _sage_const_0p0 :
    ...
    def _calculate_deco_gradient(self, Allowable_Gradient_Molecule, Amb_Press_First_Stop_Pascals, Amb_Press_Next_Stop_Pascals):
        ...
        Radius_First_Stop = (_sage_const_2p0  * self.Surface_Tension_Gamma) / Allow_Grad_First_Stop_Pa
        Radius1 = Radius_First_Stop

        A = Amb_Press_Next_Stop_Pascals
        B = -_sage_const_2p0  * self.Surface_Tension_Gamma
        C = (Amb_Press_First_Stop_Pascals + (_sage_const_2p0  * self.Surface_Tension_Gamma)/ Radius_First_Stop) * Radius_First_Stop * (Radius_First_Stop * (Radius_First_Stop))

        Low_Bound = Radius_First_Stop
        High_Bound = Radius_First_Stop * (Amb_Press_First_Stop_Pascals / Amb_Press_Next_Stop_Pascals) ** (_sage_const_1p0 /_sage_const_3p0 )

        Ending_Radius = RADIUS_ROOT_FINDER(A, B, C, Low_Bound, High_Bound)

        Radius2 = Ending_Radius
        Deco_Gradient_Pascals = (_sage_const_2p0  * self.Surface_Tension_Gamma) / Ending_Radius
    ...
    def BOYLES_LAW_COMPENSATION(self, First_Stop_Depth, Deco_Stop_Depth, Step_Size):
        ...
        Radius1_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        Radius2_He = [_sage_const_0p0  for i in range(_sage_const_16 )]
        Radius1_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]
        Radius2_N2 = [_sage_const_0p0  for i in range(_sage_const_16 )]
    ...
    def DECOMPRESSION_STOP(self, Deco_Stop_Depth, Step_Size):
        ...
        Deco_Ceiling_Depth = _sage_const_0p0
        Last_Run_Time = self.Run_Time
        Round_Up_Operation = round((Last_Run_Time / self.Minimum_Deco_Stop_Time) + _sage_const_0p5 ) * self.Minimum_Deco_Stop_Time
        ...
        for i in range(_sage_const_16 ):
            if(Inspired_Helium_Pressure + Inspired_Nitrogen_Pressure) > _sage_const_0p0 :
    ...
    def CALC_DECO_CEILING(self):
        ...
        Compartment_Deco_Ceiling = [_sage_const_0p0  for i in range(_sage_const_16 )]
        ...
        Deco_Ceiling_Depth = Compartment_Deco_Ceiling[_sage_const_0 ]
    ...
    def CRITICAL_VOLUME(self, Deco_Phase_Volume_Time):
        ...
        Parameter_Lambda_Pascals = (self.Crit_Volume_Parameter_Lambda / _sage_const_33p0 ) * self.ATM
        Phase_Volume_Time = [_sage_const_0p0  for i in range(_sage_const_16 )]
        ...
        for i in range(_sage_const_16 ):
            ...
            New_Allowable_Grad_He_Pascals = (B + sqrt(B**_sage_const_2  - _sage_const_4p0  * C))/_sage_const_2p0
            ...
            New_Allowable_Grad_N2_Pascals = (B + sqrt(B**_sage_const_2  - _sage_const_4p0  * C))/_sage_const_2p0
    ...
    def CALC_SURFACE_PHASE_VOLUME_TIME(self):
        ...
        for i in range(_sage_const_16 ):
            if self.Nitrogen_Pressure[i] > Surface_Inspired_N2_Pressure:
                ...
                Decay_Time_to_Zero_Gradient = _sage_const_1p0  / (self.Nitrogen_Time_Constant[i] - self.Helium_Time_Constant[i]) * log((Surface_Inspired_N2_Pressure - self.Nitrogen_Pressure[i])/self.Helium_Pressure[i])

                Integral_Gradient_x_Time = self.Helium_Pressure[i] / self.Helium_Time_Constant[i] * (_sage_const_1p0  - exp(-self.Helium_Time_Constant[i] * Decay_Time_to_Zero_Gradient)) + (self.Nitrogen_Pressure[i] - Surface_Inspired_N2_Pressure) / self.Nitrogen_Time_Constant[i] * (_sage_const_1p0  - exp(-self.Nitrogen_Time_Constant[i] * Decay_Time_to_Zero_Gradient))
                ...
                self.Surface_Phase_Volume_Time[i] = _sage_const_0p0
    ...
    def validate_data(self):
        ...
        if self.settings_values["Regeneration_Time_Constant"] <= _sage_const_0 :
            raise InputFileException("Regeneration_Time_Constant must be greater than 0")

        if self.units_fsw and self.altitude_values['Altitude_of_Dive'] > _sage_const_30000p0 :
            raise AltitudeException("ERROR! ALTITUDE OF DIVE HIGHER THAN MOUNT EVEREST")

        if (not self.units_fsw) and self.altitude_values['Altitude_of_Dive'] > _sage_const_9144p0 :
            raise AltitudeException("ERROR! ALTITUDE OF DIVE HIGHER THAN MOUNT EVEREST")
        ...
        # nitrogen
        if self.settings_values['Critical_Radius_N2_Microns'] < _sage_const_0p2  or self.settings_values['Critical_Radius_N2_Microns'] > _sage_const_1p35 :
        ...
        #helium
        if self.settings_values['Critical_Radius_He_Microns'] < _sage_const_0p2  or self.settings_values['Critical_Radius_He_Microns'] > _sage_const_1p35 :
    ...
    def initialize_data(self):
        ...
        if self.units_fsw:
            ...
            self.Units_Factor = _sage_const_33p0
            self.Water_Vapor_Pressure = _sage_const_1p607      #based on respiratory quotient of 0.8
                                             #(Schreiner value)
        else:
            self.Units_Word1 = "mswg"
            self.Units_Word2 = "msw/min"
            self.Units_Factor = _sage_const_10p1325
            self.Water_Vapor_Pressure = _sage_const_0p493      #based on respiratory quotient of 0.8
                                                   # (Schreiner value)
        # INITIALIZE CONSTANTS/VARIABLES
        self.Constant_Pressure_Other_Gases = (self.settings_values["Pressure_Other_Gases_mmHg"] / _sage_const_760p0 ) * self.Units_Factor
        self.Run_Time = _sage_const_0p0
        self.Segment_Number = _sage_const_0

        for i in range(_sage_const_16 ):
            self.Helium_Time_Constant[i] = log(_sage_const_2p0 ) / self.Helium_Half_Time[i]
            self.Nitrogen_Time_Constant[i] = log(_sage_const_2p0 ) / self.Nitrogen_Half_Time[i]
            self.Max_Crushing_Pressure_He[i] = _sage_const_0p0
            self.Max_Crushing_Pressure_N2[i] = _sage_const_0p0
            self.Max_Actual_Gradient[i] = _sage_const_0p0
            self.Surface_Phase_Volume_Time[i] = _sage_const_0p0
            self.Amb_Pressure_Onset_of_Imperm[i] = _sage_const_0p0
            self.Gas_Tension_Onset_of_Imperm[i] = _sage_const_0p0
            self.Initial_Critical_Radius_N2[i] = self.settings_values["Critical_Radius_N2_Microns"] * _sage_const_1p0En6
            self.Initial_Critical_Radius_He[i] = self.settings_values["Critical_Radius_He_Microns"] * _sage_const_1p0En6
        ...
        if self.settings_values["Altitude_Dive_Algorithm"].lower() == "on":
            self.Altitude_Dive_Algorithm_Off = False
            if self.altitude_values["Ascent_to_Altitude_Hours"] <= _sage_const_0  and self.Diver_Acclimatized is False:
    ...
    def set_gas_mixes(self, dive):
        ...
        self.Fraction_Oxygen = [_sage_const_0p0  for i in range(num_gas_mixes)]
        self.Fraction_Helium  = [_sage_const_0p0  for i in range(num_gas_mixes)]
        self.Fraction_Nitrogen = [_sage_const_0p0  for i in range(num_gas_mixes)]
        ...
        for i in range(num_gas_mixes):
            ...
            if Sum_of_Fractions != _sage_const_1p0 :
    ...
    def profile_code_loop(self, dive):
        ...
        for profile in dive["profile_codes"]:
            ...
            elif Profile_Code == _sage_const_2 :
            ...
            elif Profile_Code == _sage_const_99 :
                break
            else:
    ...
    def deco_stop_loop_block_within_critical_volume_loop(self):
        ...
        while(True):
            ...
            if self.Deco_Stop_Depth <= _sage_const_0p0 :
                break

            if self.Number_of_Changes > _sage_const_1 :
                for i in range(_sage_const_1 , self.Number_of_Changes):
    ...
    def critical_volume_decision_tree(self):
        ...
        self.Starting_Depth = self.Depth_Change[_sage_const_0 ]
        self.Mix_Number = self.Mix_Change[_sage_const_0 ]
        self.Rate = self.Rate_Change[_sage_const_0 ]
        self.Step_Size = self.Step_Size_Change[_sage_const_0 ]
        ...
        while(True):
            ...
            if self.Last_Run_Time == _sage_const_0p0 :
                self.Stop_Time = round((self.Segment_Time / self.Minimum_Deco_Stop_Time) + _sage_const_0p5 ) * self.Minimum_Deco_Stop_Time
            else:
    ...
    def critical_volume_loop(self):
        ...
        while(True):
            ...
            if self.Ascent_Ceiling_Depth <= _sage_const_0p0 :
                self.Deco_Stop_Depth = _sage_const_0p0
            else:
                Rounding_Operation2 = (self.Ascent_Ceiling_Depth / self.Step_Size) + _sage_const_0p5
            ...
            for i in range(_sage_const_16 ):
                ...
                if self.Critical_Volume_Comparison <= _sage_const_1p0 :
    ...
    def decompression_loop(self, dive):
        ...
        for profile in dive["profile_codes"]:
            ...
            if Profile_Code == _sage_const_99 :
                self.Number_of_Changes = profile["number_of_ascent_parameter_changes"]
                self.Depth_Change = [_sage_const_0p0  for i in range(self.Number_of_Changes)]
                self.Mix_Change = [_sage_const_0p0  for i in range(self.Number_of_Changes)]
                self.Rate_Change = [_sage_const_0p0  for i in range(self.Number_of_Changes)]
                self.Step_Size_Change = [_sage_const_0p0  for i in range(self.Number_of_Changes)]
        ...
        if self.units_fsw:
            if self.Step_Size < _sage_const_10p0 :
                rounding_op = (self.Depth_Start_of_Deco_Zone / self.Step_Size) - _sage_const_0p5
                self.Deepest_Possible_Stop_Depth = round(rounding_op) * self.Step_Size
            else:
                rounding_op = (self.Depth_Start_of_Deco_Zone/_sage_const_10p0 ) - _sage_const_0p5
                self.Deepest_Possible_Stop_Depth = round(rounding_op) * _sage_const_10p0

        else:
            if self.Step_Size < _sage_const_3p0 :
                rounding_op = (self.Depth_Start_of_Deco_Zone / self.Step_Size) - _sage_const_0p5
                self.Deepest_Possible_Stop_Depth = round(rounding_op) * self.Step_Size
            else:
                rounding_op = (self.Depth_Start_of_Deco_Zone / _sage_const_3p0 )  - _sage_const_0p5
                self.Deepest_Possible_Stop_Depth = round(rounding_op) * _sage_const_3p0
        ...
        for i in range(_sage_const_16 ):
            self.Last_Phase_Volume_Time[i] = _sage_const_0p0
    ...
    def main(self):
        ...
        for dive in self.input_values:
            ...
            if Repetitive_Dive_Flag == _sage_const_0 :
                continue
            ...
            elif Repetitive_Dive_Flag == _sage_const_1 :
...
class Output(object):
    ...
    def new_dive(self, description):
        ...
        if self.current_dive is None:
            self.current_dive = _sage_const_0
        else:
            self.current_dive += _sage_const_1
    ...
    def html_description_time_and_gasmix(self, dive):
        ...
        for i, gas in enumerate(dive["gasmix"]):
            ...
            """ %(i+_sage_const_1 , gas["oxygen"], gas["helium"], gas["nitrogen"])
        return_string += "</table>"
...
def SCHREINER_EQUATION(Initial_Inspired_Gas_Pressure, Rate_Change_Insp_Gas_Pressure, Interval_Time, Gas_Time_Constant, Initial_Gas_Pressure):
    ...
    return Initial_Inspired_Gas_Pressure + Rate_Change_Insp_Gas_Pressure * (Interval_Time - _sage_const_1p0  / Gas_Time_Constant) - (Initial_Inspired_Gas_Pressure - Initial_Gas_Pressure - Rate_Change_Insp_Gas_Pressure/Gas_Time_Constant) * exp (-Gas_Time_Constant*Interval_Time)
...
def HALDANE_EQUATION (Initial_Gas_Pressure, Inspired_Gas_Pressure, Gas_Time_Constant, Interval_Time):
    ...
    return Initial_Gas_Pressure + (Inspired_Gas_Pressure - Initial_Gas_Pressure) * (_sage_const_1p0  - exp(-Gas_Time_Constant * Interval_Time))
...
def RADIUS_ROOT_FINDER (A, B, C, Low_Bound, High_Bound):
    ...
    if Function_at_Low_Bound > _sage_const_0p0  and Function_at_High_Bound > _sage_const_0p0 :
        raise RootException("ERROR! ROOT IS NOT WITHIN BRACKETS")
    ...
    if Function_at_Low_Bound == _sage_const_0p0 :
        return Low_Bound
    elif Function_at_High_Bound == _sage_const_0p0 :
        return High_Bound
    elif Function_at_Low_Bound < _sage_const_0p0 :
    ...
    Ending_Radius = _sage_const_0p5  * (Low_Bound + High_Bound)
    ...
    Derivative_of_Function = Ending_Radius * (Ending_Radius * _sage_const_3p0  * A - _sage_const_2p0  * B)

    for i in range(_sage_const_100 ):
        if((((Ending_Radius-Radius_at_High_Bound) * Derivative_of_Function - Function) *
            ((Ending_Radius-Radius_at_Low_Bound)* Derivative_of_Function - Function) >= _sage_const_0p0 )
           or (abs(_sage_const_2p0  * Function) > (abs(Last_Diff_Change*Derivative_of_Function)))):

            Last_Diff_Change = Differential_Change
            Differential_Change = _sage_const_0p5  * (Radius_at_High_Bound - Radius_at_Low_Bound)
            ...
            if Last_Ending_Radius == Ending_Radius:
                return Ending_Radius
        if abs(Differential_Change) < _sage_const_1p0En12 :
            return Ending_Radius
        Function = Ending_Radius * (Ending_Radius * (A * Ending_Radius - B)) - C

        Derivative_of_Function = Ending_Radius * (Ending_Radius * _sage_const_3p0  * A - _sage_const_2p0  * B)

        if Function < _sage_const_0p0 :
...
def CALC_BAROMETRIC_PRESSURE(Altitude, units_fsw):
    ...
    Radius_of_Earth = _sage_const_6369p0                                        #kilometers
    Acceleration_of_Gravity = _sage_const_9p80665                          #meters/second^2
    Molecular_weight_of_Air = _sage_const_28p9644                                     #mols
    Gas_Constant_R = _sage_const_8p31432                             #Joules/mol*deg Kelvin
    Temp_at_Sea_Level = _sage_const_288p15                                  #degrees Kelvin

    Pressure_at_Sea_Level_Fsw = _sage_const_33p0       #feet of seawater based on 101325 Pa
                                             #at sea level (Standard Atmosphere)

    Pressure_at_Sea_Level_Msw = _sage_const_10p0     #meters of seawater based on 100000 Pa
                                                 #at sea level (European System)

    Temp_Gradient = -_sage_const_6p5                        #Change in Temp deg Kelvin with
    ...
    if units_fsw:
        ...
        Altitude_Kilometers = Altitude_Feet / _sage_const_3280p839895
        Pressure_at_Sea_Level = Pressure_at_Sea_Level_Fsw
    else:
        Altitude_Meters = Altitude
        Altitude_Kilometers = Altitude_Meters / _sage_const_1000p0
