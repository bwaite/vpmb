...
to structure data for easy computer reading and writing}}, that is supported by just about every programming language \footnote{Though not FORTRAN, so a translator was written to let the original program load the new input files}.
